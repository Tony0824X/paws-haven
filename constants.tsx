...
export const MOCK_PETS: Pet[] = [
  ...
  },
  {
    ...
    location: '沙田, 香港',
    traits: ['溫和', '1歲'],
    images: ["https://lh3.googleusercontent.com/aida-public/AB6AXuB6IQ-dv8NHJTUuS0_HqKXJYfJ78kSY8xaT4PLWRDuZ7-kd9v0NFpMKxpCwq7Iat1FzdDBywZdUx8jDg7mxkN2FhvWYowAFiWXelreChzi7iFCcQtTqbYFHbj87N4vFm6Lwsuyrr8tOa6oGp4b-rHdGkjgD5OyIomSUtAPPnZs1rU3wejfr6AoHLlhT3CNQU9vgsmIg5SytfcXjTFscP9QQQrJjXWdWXB4Lx6OOkFQBbDm__K-J_qyDOwnnkk0Rgsj03N75Dg8GEqs"],
    healthStatus: ['已打疫苗', '已結紮'],
    description: ["Luna 是個安靜的小淑女。"]
  },
  {
    id: '3',
    name: 'Snowball',
  ...
  },
  {
    ...
    isNew: true,
    traits: ['親人', '女生'],
    images: ["https://lh3.googleusercontent.com/aida-public/AB6AXuCoq36ipYS04GMimMLUQ9L3GXvsTXM7RHAIPlfY8qYuvn4nBi1Obzu9_8nFfhpI3yiKHtukiJuQkaN3m5rAgnrnNU1r5F1EHX_0I2TscZXGQiCzV5JtwfX8DehlGDuvFeBAEX06sW38EdEASecfKp11hBtzyg1KPfCXhE6a3JtYy8k5YBYcF7iKJuBulWD_ClpKja7hZed7ZUtgj4YIhnnhNj0uhfjf7uxTBsojxdgLH-HP94U-s1QDANsFldtHLVWCmHxoWzhSVcQ"],
    healthStatus: ['已打疫苗', '已結紮'],
    description: ["活潑好動的虎斑小貓。"]
  },
  {
    id: '5',
    name: 'Oreo',
    ...
    location: '西貢, 香港',
    traits: ['安靜'],
    images: ["https://lh3.googleusercontent.com/aida-public/AB6AXuDewTQtuGQM3C4CyoaLxXtnAsSOcklb8Bodo7eJ3s1BM5FB9U_ghD9FiPuH953sbRR0x9Nz3rQv_SGcYPuFpEbiTjZAs7XXcPuIb-tw0mUPJx82CEd9UU5WMoAX6hnuvvrg-HRV7alAGMce02QJzO5s_b_BicffwTwUN_yKptk_I0cploSgknxxYcGMC_NEE9tRTBbC09A1X09JmBjvCbSuX3pEyZFhUXZp0DHKd60HNdM5HIwGP_yLwATEzXzIZP4OldKoSykoxY0"],
    healthStatus: ['已檢查健康'],
    description: ["喜歡吃紅蘿蔔的安靜兔子。"]
  },
  {
    id: '6',
    name: 'Kiwi',
    ...
    location: '九龍城, 香港',
    traits: ['聰明'],
    images: ["https://lh3.googleusercontent.com/aida-public/AB6AXuAApO35XRLZInn4kXWXTfAIjU7zz2NPYKYKn87Rq76cQ5rxIwTQAtIKR5gddSVLe4IcpZ6YXKb1GfmSJVyM8w-Ubcn9M8mJUA99ZpgHIzkjFZMcLwh8mPZB6tpOwbuPMcX_eRd5H0az1DMeA_T4dhqyXQ95u8rDGbYY6B2_meuR47-pBSIoa6Zomb9D0ddGJQiFBe8mRljqwDYQrugK-n3OpxnX1FXwWBgHvoQghS0Z88CH79ip8aYlSNkn8Arv8ce0f2aNKZ5OhQA"],
    healthStatus: ['已打疫苗'],
    description: ["會模仿說話的聰明鸚鵡。"]
  }
];

export const MOCK_APPLICATIONS: Application[] = [
  { id: 'app1', petName: 'Luna', petBreed: '三色貓', status: '審核中' },
  { id: 'app2', petName: 'Snowball', petBreed: '馬爾濟斯', status: '已通過' }
];
